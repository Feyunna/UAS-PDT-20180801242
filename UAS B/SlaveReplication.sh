...
#setelah semua selesai mulai dari lagi sini, 
...
#######################
# ADD THIS LATER
# sudo -u postgres pg_basebackup -h 10.11.11.31 -D /var/lib/postgresql/10/main -U replicationuser -v -P --wal-method=stream
# sudo sed -i 's/#primary_conninfo = ''/primary_conninfo = 'host=10.11.11.31 port=5432 user=replicationuser password=admin'/' /var/lib/postgresql/9.5/main/recovery.conf